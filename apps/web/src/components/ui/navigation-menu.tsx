...
>(({ className, ...props }, ref) => (
  <div className={cn('absolute left-0 top-full flex justify-center')}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        'origin-top-center h-(--radix-navigation-menu-viewport-height) bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:w-(--radix-navigation-menu-viewport-width) relative mt-1.5 w-full overflow-hidden rounded-md border shadow-lg',
        className
      )}
      ref={ref}
      {...props}
