...
export async function DynamicZone({ as = 'div', sections }: { as?: 'div' | 'section'; sections: PageComponent[] }) {
  return sections.map((section) => {
    switch (section.__component) {
      ...
      case 'page-components.contact-form':
        return <ContactFormSection key={`contact-form-${section.id}`} {...section} as={as} />;
